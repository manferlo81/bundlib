...
async function pluginLoader<T extends PluginImpl>(name: string, others: string[] | null, exportName: string, dependencies: Record<string, string> | null): Promise<T | null> {
